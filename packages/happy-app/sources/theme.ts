...
export const lightTheme = {
    ...
    colors: {
        ...
        diff: {
            ...
            inlineAddedBg: '#BFE6B8',
            inlineAddedText: '#1B5E20',
            inlineRemovedBg: '#F2C4C0',
            inlineRemovedText: '#7A1D17',
        },
...
export const darkTheme = {
    ...
    colors: {
        ...
        diff: {
            ...
            inlineAddedBg: '#2C5B38',
            inlineAddedText: '#A9E2AE',
            inlineRemovedBg: '#5D3034',
            inlineRemovedText: '#F2A4AB',
        },
